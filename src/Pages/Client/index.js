    ...
    return(
        <div className='flex h-screen bg-gray-100'>
            <div className='flex flex-col w-full overflow-auto'>
                <div className="flex items-center bg-gray-100 self-center justify-center align-middle w-full sm:pl-20 sm:pr-20 pr-1 pl-16 mt-32 rounded-xl py-10">
                    <div className="flex flex-col w-full">
                        <div className='flex sm:flex-row flex-col sm:items-center items-end justify-between w-full align-middle'>
